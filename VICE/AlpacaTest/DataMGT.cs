...
namespace AlpacaFinal
{
    public partial class DataMGT : Form
    {
        ...
        {
            string connection = "S14_VICE_Connection";
            string rpm = "S14VICE_RPM"; 
            string flow = "S14VICE_Flow";
            string pressure = "S14VICE_Pressure";
            ...
            {
                case "C":                          //if Pressure
                    // string pressureVal = pressure + PIout.ToString();
                    try
                    {
                ...
                case "PR":                          //if Pressure
                   // string pressureVal = pressure + PIout.ToString();
                    ...
                    break;
                case "RPM":                          //if RPM
                   // string rpmVal = rpm + PIout.ToString();
                    try
                    {
                        myPI.connect_Server("ESMARTSERVER-PC");
                        ...
                        {
                            //Setting the value of the point
                            myPI.setPiPointValue(rpm, (float.Parse(value)));
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "F":                          //if Flow
                    //string flowVal = flow + PIout.ToString();
                    try
                    {
                        myPI.connect_Server("ESMARTSERVER-PC");
